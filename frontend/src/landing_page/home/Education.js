        ...
        <div className='container  mt-5 '>
                  ...
                  <div className='col-6 '>
                       ...
                       <div className='col-6'>
                        ...
                        <p className='text-muted'>TradingQ&A,Varsity, the largest online stock market education book in the world covering everything from the basics to advanced trading.</p>
